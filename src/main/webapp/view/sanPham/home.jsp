...
<button type="submit"><a href="/san-pham/view-add">Thêm sản phẩm</a></button>
<div class="gap-element clearfix" style="display:block; height:auto; padding-top:50px"></div>
    ...
    <c:forEach items="${list}" var="sp" varStatus="i">
        <tr>
            ...
            <td>
                ...
                <button><a href="/san-pham/view-update?id=${sp.id}">Edit</a></button>
                <button onclick="return confirm('Bạn chắc chắn muốn xóa')"><a
                        href="/san-pham/remote?id=${sp.id}">Remove</a></button>
            </td>
        </tr>
    </c:forEach>
    </tbody>
