...
<div class="gap-element clearfix" style="display:block; height:auto; padding-top:30px"></div>
<button type="submit"><a href="/khach-hang/view-add">Thêm khách hàng</a></button>
    ...
    <c:forEach items="${list}" var="kh" varStatus="i">
        <tr>
            ...
            <td>
                ...
                <button><a href="/khach-hang/view-update?id=${kh.id}">Edit</a></button>
                <button onclick="return confirm('Bạn chắc chắn muốn xóa')"><a href="/khach-hang/remote?id=${kh.id}">Remove</a>
                </button>
            </td>
        </tr>
    </c:forEach>
